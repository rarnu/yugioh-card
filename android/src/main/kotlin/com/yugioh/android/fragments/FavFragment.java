...
public class FavFragment extends BaseFragment implements Loader.OnLoadCompleteListener<Cursor>, AdapterView.OnItemClickListener {
    ...
    public void initComponents() {
        lvList = (ListView) getInnerView().findViewById(R.id.lvList);
        tvListNoCard = (TextView) getInnerView().findViewById(R.id.tvListNoCard);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        MiscUtils.INSTANCE.openCardDetail(getActivity(), cSearch, position);
    }
}
