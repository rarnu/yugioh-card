...
public class YGOAPI {
    ...
    public static UpdateInfo findUpdate(Context context, int dbVer, int lastCardId) {
        ...
        UpdateInfo ui = null;
        try {
            String jsonstr = HttpUtils.get(NetworkDefine.UPDATE_URL, param);
    ...
    public static List<RecommandInfo> getRecommands() {
        ...
        try {
            String ret = HttpUtils.get(NetworkDefine.RECOMMAND_URL, "");
    ...
    public static List<PackageItem> getPackageList() {
        ...
        try {
            String ret = HttpUtils.get(NetworkDefine.URL_OCGSOFT_GET_PACKAGE, "");
    ...
    public static CardItems getPackageCards(String id) {
        CardItems item = null;
        try {
            String ret = HttpUtils.get(String.format(NetworkDefine.URL_OCGSOFT_GET_PACKAGE_CARD, id), "");
            JSONObject json = new JSONObject(ret);
            item = new CardItems();
    ...
    public static boolean sendFeedback(Context context, String text) {
        ...
        try {
            ...
            String str = HttpUtils.get(NetworkDefine.FEEDBACK_URL, String.format(NetworkDefine.FEEDBACK_PARAM_FMT, deviceId, email, text, appver, osver));
            ret = !str.equals("0");
        } catch (Exception e) {
